        ...
        <div className="mt-8 flex justify-center gap-6">
          {[
            ...
            <a
              ...
              href={href}
              aria-label={label}
              className="flex h-10 w-10 items-center justify-center rounded-full border border-primary/25 text-foreground/70 transition-all duration-500 hover:border-primary hover:text-primary"
            >
