        ...
        <Reveal delay={280}>
          {status === "success" ? (
            ...
            >
              ...
              <button
                type="submit"
                className="border border-primary bg-primary px-6 py-4 text-[11px] uppercase tracking-[0.28em] text-primary-foreground transition-all duration-500 hover:bg-transparent hover:text-primary"
              >
                Reserve My Spot
              </button>
            </form>
